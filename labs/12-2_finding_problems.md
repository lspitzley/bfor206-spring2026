# Lab 12-2: Finding and Documenting Issues

## Task Description

The goal of this lab is to begin developing the code that
satisfies the project requirements and passes tests. It is 
expected that you will find issues in the requirements, tests,
or both. When you find an issue, create a new issue on GitHub to
document the problem.

## Submission Instructions

1. For the area you are responsible for implementing, assign or create
an issue on GitHub for the specific part that you plan to implement and
assign it to yourself.
2. In your codespace, create a new branch for the issue by following the steps
...
To receive credit for this lab, you must create one issue. Include a description that
explains the problem, which files are affected, and any potential solutions you have identified.